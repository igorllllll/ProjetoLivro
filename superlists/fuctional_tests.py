...
class NewVisitorTest(unittest.TestCase):
	...
	def test_can_start_a_list_and_retrieve_it_later(self):
		...
		#de texto (o hobby de Edith pe fazes iscas para pesca com fly)
		...
		# "1: Buy peacok feathers" como um item em uma lista de tarefas
		...
		self.assertTrue(
			...
			"novo item de tarefa não apareceu na tabela"		
		)
		
		
		#Ainda continua havendo uma caixa de texto convidado-a a acrescentar outro
		#item. Ela insere "Use peacok feathers to make fly" (Usar penas de pavão
